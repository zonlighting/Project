...
public class UploadFile {
  public static String saveFile(MultipartFile multipartFile)
    ...
    String fileNameImage =
        String.format("%s_%s", now.format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")),
            multipartFile.getOriginalFilename());
    String destination =
        System.getProperty("user.dir") + "/src/main/webapp/images/" + fileNameImage;
    File file = new File(destination);
    multipartFile.transferTo(file);
    return "/images/" + fileNameImage;
  }

  public static String saveVideo(MultipartFile multipartFile)
      throws IllegalStateException, IOException {
